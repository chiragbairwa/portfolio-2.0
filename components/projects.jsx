        ...
        <div className="projects-card">
          ...
          <div className="card second-project-card" id="project-card2" data-aos="fade-right">
            <div className="projects-card-content">
              ...
              <div className="project-btn-container">
                ...
                <a
                  href="https://github.com/chiragbairwa/pokedex-app"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="project-btn"
                >
          ...
          <div className="card" id="project-card3" data-aos="fade-left">
            ...
            <div className="projects-card-content">
              ...
              <p>This WebApp is used to Login / SignUp in the Application.</p>

              <div className="project-btn-container">
                <a
                  href="https://log-auth-rho.vercel.app/signin"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="project-btn"
                >
                ...
                <a
                  href="https://github.com/chiragbairwa/Log-Auth"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="project-btn"
                >
